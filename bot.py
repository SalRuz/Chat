...
# ─── can_roll хранится в памяти, не в БД ───
ROOM_CAN_ROLL: Dict[str, bool] = {}

TRANSLATIONS = {
    'en': {
        'welcome': "🎩 Welcome to **RUZOPOLY**!\n\nMonopoly-style game with **Ruzcoin** 💰\n\nChoose your language:",
        'create_room': "🏠 Create Room",
        'join_by_code': "🚪 Join by Code",
        'browse_rooms': "📋 Browse Rooms",
        'choose_max_players': "👥 Choose max players:",
        'players': "players",
        'password_question': "Max players: {}. Set a password?",
        'with_password': "🔒 With Password",
        'no_password': "🔓 No Password",
        'enter_password': "🔐 Enter room password:",
        'allow_buyout_question': "Allow property buyout from other players?",
        'allow_buyout': "✅ Allow Buyout",
        'no_buyout': "❌ No Buyout",
        'allow_partial_build_question': "Allow building houses without owning the full color group?",
        'allow_partial_build': "✅ Allow Partial Build",
        'no_partial_build': "❌ Require Full Group",
        ...
        'passed_start': "💰 {} passed START and got +$200",
        'at_start': "🏁 {} landed on START +$200",
        'chest_reward': "💎 {} got +${} from Community Chest!",
        'tax_paid': "💸 {} paid -${} in taxes",
        'visiting_jail': "👀 {} is just visiting jail",
        'at_parking': "🅿️ {} is at free parking",
        'go_to_jail': "🚔 {} goes to JAIL!",
        'rent_paid': "💰 {} paid ${} rent to {} for {}",
        'own_property': "🏠 {} landed on their own property: {}",
        'free_property': "🏡 {} can buy: **{}** for ${} (rent ${})",
        'not_enough_money': "💸 {} doesn't have enough money!",
        'property_bought': "✅ {} bought {} for ${}!",
        'property_buyout': "💎 {} bought out {} from {} for ${}!",
        'purchase_declined': "❌ {} declined to purchase",
        'timeout': "⏰ {} ran out of time!",
        'jail_doubles': "🎲 {} rolled {}+{} doubles and is free!",
        'jail_no_doubles': "🎲 {} is stuck in jail ({}+{}), {} turns left",
        'jail_pay_forced': "🎲 {} forced to pay $150 to get out",
        'jail_paid_out': "💰 {} paid $150 and is free!",
        'available_rooms': "📋 **Available Rooms:**\n\n",
        'no_rooms': "📋 No rooms available",
        'join': "Join {}",
        'back': "« Back",
        'enter_room_code': "🔑 Enter room code:",
        'room_has_password': "🔒 This room has a password. Enter it:",
        'wrong_password': "❌ Wrong password!",
        'already_in_room': "You're already in this room!",
        'joined_room': "✅ Joined room `{}`!",
        'only_creator_start': "Only the room creator can start the game!",
        ...
        'game_over': "🎮 Game Over!",
        'debt_warning': "⚠️ {} is in debt! Sell properties to pay off.",
        'property_sold': "💰 {} sold {} for ${}",
        'all_stations_owned': "🚉 {} owns all railroads!",
        'three_streets_owned': "🏘️ {} owns 3 color groups!",
        'moving_countdown': "⏱️ Moving in {}s...",
        'turn_end_countdown': "⏱️ Turn ends in {}s...",
        'decision_time': "⏱️ {} has {}s to decide",
        'waiting': "⏳ Please wait...",
        'doubles_turn': "🎲 {} gets an extra turn for doubles!",
        'house_built': "🏠 {} built a house on {} (level {}→{})",
        'hotel_built': "🏨 {} built a HOTEL on {}!",
        'max_houses': "Maximum buildings reached!",
        'trade': "🔄 Trade",
        'trade_select_player': "🔄 Select a player to trade with:",
        'trade_select_want': "What do you want from them?",
        'trade_select_give': "What will you give in return?",
        'trade_enter_money': "💰 Enter money amount:",
        'trade_money': "💰 Money",
        'trade_cancel': "❌ Cancel Trade",
        'trade_confirm': "✅ Accept Trade",
        'trade_reject': "❌ Decline Trade",
        'trade_proposal': "🔄 **Trade proposal from {}:**\nWants: {}\nOffers: {}\nDo you accept?",
        'trade_accepted': "🔄 Trade completed! {} ↔ {}",
        'trade_rejected': "🔄 {} declined the trade",
    ...
    'ru': {
        ...
        'choose_max_players': "👥 Выберите максимум игроков:",
        'players': "игроков",
        'password_question': "Максимум игроков: {}. Установить пароль?",
        'with_password': "🔒 С паролем",
        'no_password': "🔓 Без пароля",
        'enter_password': "🔐 Введите пароль комнаты:",
        'allow_buyout_question': "Разрешить выкуп недвижимости у других игроков?",
        'allow_buyout': "✅ Разрешить выкуп",
        'no_buyout': "❌ Запретить выкуп",
        'allow_partial_build_question': "Разрешить строительство без полной группы цвета?",
        'allow_partial_build': "✅ Разрешить",
        'no_partial_build': "❌ Требовать полную группу",
        'choose_turn_time': "⏰ Выберите время хода:",
        ...
        'tax_paid': "💸 {} заплатил -${} налогов",
        'visiting_jail': "👀 {} просто посещает тюрьму",
        'at_parking': "🅿️ {} на бесплатной парковке",
        'go_to_jail': "🚔 {} отправляется в ТЮРЬМУ!",
        'rent_paid': "💰 {} заплатил ${} ренты {} за {}",
        'own_property': "🏠 {} на своей собственности: {}",
        'free_property': "🏡 {} может купить: **{}** за ${} (рента ${})",
        ...
        'timeout': "⏰ {} — время вышло!",
        'jail_doubles': "🎲 {} выбросил {}+{} дубль и свободен!",
        'jail_no_doubles': "🎲 {} остаётся в тюрьме ({}+{}), осталось: {} ходов",
        'jail_pay_forced': "🎲 {} вынужден заплатить $150 за выход",
        'jail_paid_out': "💰 {} заплатил $150 и свободен!",
        'available_rooms': "📋 **Доступные комнаты:**\n\n",
        'no_rooms': "📋 Нет доступных комнат",
        'join': "Войти {}",
        'back': "« Назад",
        'enter_room_code': "🔑 Введите код комнаты:",
        'room_has_password': "🔒 Эта комната защищена паролем. Введите его:",
        'wrong_password': "❌ Неверный пароль!",
        'already_in_room': "Вы уже в этой комнате!",
        'joined_room': "✅ Вы вошли в комнату `{}`!",
        'only_creator_start': "Только создатель комнаты может начать игру!",
        'not_enough_ruzcoin': "Недостаточно Ruzcoin!",
        'nothing_to_buy': "Нечего покупать",
        'language_selected': "Русский 🇷🇺 выбран!",
        'player_eliminated': "💀 {} выбыл из игры!",
        'player_won': "🏆 {} ПОБЕДИЛ!",
        'game_over': "🎮 Игра окончена!",
        'debt_warning': "⚠️ {} в долгу! Продайте собственность.",
        'property_sold': "💰 {} продал {} за ${}",
        'all_stations_owned': "🚉 {} владеет всеми вокзалами!",
        'three_streets_owned': "🏘️ {} владеет 3 цветовыми группами!",
        'moving_countdown': "⏱️ Ход через {}с...",
        'turn_end_countdown': "⏱️ Конец хода через {}с...",
        'decision_time': "⏱️ {} решает... {}с",
        'waiting': "⏳ Подождите...",
        'doubles_turn': "🎲 {} получает дополнительный ход за дубль!",
        'house_built': "🏠 {} построил дом на {} (уровень {}→{})",
        'hotel_built': "🏨 {} построил ОТЕЛЬ на {}!",
        'max_houses': "Максимум построек!",
        'trade': "🔄 Обмен",
        'trade_select_player': "🔄 Выберите игрока для обмена:",
        'trade_select_want': "Что вы хотите получить?",
        'trade_select_give': "Что вы отдадите взамен?",
        'trade_enter_money': "💰 Введите сумму денег:",
        'trade_money': "💰 Деньги",
        'trade_cancel': "❌ Отменить обмен",
        'trade_confirm': "✅ Принять обмен",
        'trade_reject': "❌ Отклонить обмен",
        'trade_proposal': "🔄 **Предложение обмена от {}:**\nХочет: {}\nПредлагает: {}\nПринять?",
        'trade_accepted': "🔄 Обмен завершён! {} ↔ {}",
        'trade_rejected': "🔄 {} отклонил обмен",
...
def init_db():
    ...
    if c.fetchone():
        ...
        c.execute(
            "CREATE TABLE users(id INTEGER PRIMARY KEY, username TEXT, language TEXT DEFAULT 'en', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)")

    c.execute("SELECT name FROM sqlite_master WHERE type='table' AND name='rooms'")
    if c.fetchone():
        c.execute("PRAGMA table_info(rooms)")
        cols = [x[1] for x in c.fetchall()]
        for col, td in [('language', 'TEXT DEFAULT "en"'), ('player_ids', 'TEXT DEFAULT "[]"'),
                         ('allow_buyout', 'BOOLEAN DEFAULT 1'), ('turn_time', 'INTEGER DEFAULT 30'),
                         ('awaiting_buyout', 'BOOLEAN DEFAULT 0'),
                         ('allow_partial_build', 'BOOLEAN DEFAULT 0')]:
            if col not in cols:
                c.execute(f"ALTER TABLE rooms ADD COLUMN {col} {td}")
    else:
        c.execute(
            "CREATE TABLE rooms(code TEXT PRIMARY KEY, creator_id INTEGER, chat_id INTEGER, max_players INTEGER, "
            "password TEXT, current_turn INTEGER DEFAULT 0, is_started BOOLEAN DEFAULT 0, last_message_id INTEGER, "
            "chance_deck TEXT, risk_deck TEXT, awaiting_buy INTEGER, awaiting_buyout BOOLEAN DEFAULT 0, "
            "language TEXT DEFAULT 'en', player_ids TEXT DEFAULT '[]', allow_buyout BOOLEAN DEFAULT 1, "
            "turn_time INTEGER DEFAULT 30, allow_partial_build BOOLEAN DEFAULT 0, "
            "created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)")

    c.execute(
        "CREATE TABLE IF NOT EXISTS players(room_code TEXT, user_id INTEGER, name TEXT, money INTEGER DEFAULT 1500, "
        "position INTEGER DEFAULT 0, color TEXT, is_bot BOOLEAN DEFAULT 0, in_jail BOOLEAN DEFAULT 0, "
        "jail_turns INTEGER DEFAULT 0, is_active BOOLEAN DEFAULT 1, doubles_count INTEGER DEFAULT 0, "
    ...
    c.execute(
        "CREATE TABLE IF NOT EXISTS ownership(room_code TEXT, cell_idx INTEGER, owner_id INTEGER, houses INTEGER DEFAULT 0, "
        "PRIMARY KEY(room_code, cell_idx))")
    c.execute("PRAGMA table_info(ownership)")
    ocols = [x[1] for x in c.fetchall()]
    if 'houses' not in ocols:
        c.execute("ALTER TABLE ownership ADD COLUMN houses INTEGER DEFAULT 0")

    c.execute("CREATE TABLE IF NOT EXISTS user_room(user_id INTEGER PRIMARY KEY, room_code TEXT)")
    c.execute(
        "CREATE TABLE IF NOT EXISTS player_messages(room_code TEXT, user_id INTEGER, message_id INTEGER, "
        "PRIMARY KEY(room_code, user_id))")
    conn.commit()
    conn.close()
...
GROUP_COLORS_HEX = {
    ...
    "red": "#FF3030", "yellow": "#FFD700", "green": "#2E8B57", "darkblue": "#1E3A8A"
}
...
CHANCE_CARDS = [
    {"text": "🎉 You won a lottery! +$200", "text_ru": "🎉 Вы выиграли в лотерею! +$200", "effect": 200},
    {"text": "🚗 Speeding fine -$50", "text_ru": "🚗 Штраф за превышение -$50", "effect": -50},
    {"text": "🏦 Bank dividends +$100", "text_ru": "🏦 Дивиденды из банка +$100", "effect": 100},
    {"text": "🚓 Traffic fine -$100", "text_ru": "🚓 Штраф за нарушение -$100", "effect": -100},
    {"text": "🎂 It's your birthday! +$50 from each player",
     "text_ru": "🎂 У вас день рождения! +$50 от каждого игрока", "effect": "birthday"},
    {"text": "📈 Stock profits +$150", "text_ru": "📈 Прибыль от акций +$150", "effect": 150},
    {"text": "🔧 Property repairs -$100", "text_ru": "🔧 Ремонт собственности -$100", "effect": -100},
    {"text": "🎁 You received a gift +$100", "text_ru": "🎁 Вы получили подарок +$100", "effect": 100},
]

RISK_CARDS = [
    {"text": "💸 Emergency tax -$150", "text_ru": "💸 Экстренный налог -$150", "effect": -150},
    {"text": "🎁 Unexpected gift +$100", "text_ru": "🎁 Неожиданный подарок +$100", "effect": 100},
    {"text": "🏥 Hospital bill -$100", "text_ru": "🏥 Больничный счёт -$100", "effect": -100},
    {"text": "💼 Work bonus +$200", "text_ru": "💼 Рабочая премия +$200", "effect": 200},
    {"text": "📚 Education costs -$50", "text_ru": "📚 Расходы на образование -$50", "effect": -50},
    {"text": "🎰 Casino winnings +$250", "text_ru": "🎰 Выигрыш в казино +$250", "effect": 250},
]
...
class Room:
    ...
    @property
    def can_roll(self):
        return ROOM_CAN_ROLL.get(self.code, True)

    @can_roll.setter
    def can_roll(self, val):
    ...
    def next_turn(self):
        a = self.active_players()
        if a:
            self.current_turn = (self.current_turn + 1) % len(a)

    def add_event(self, e):
        s = get_room_state(self.code)
        s['event_log'].append(e)
        if len(s['event_log']) > 8:
            s['event_log'].pop(0)
...
class Database:
    ...
    def save_user(uid, uname, lang='en'):
        ...
        try:
            ...
            if c.fetchone():
                ...
                conn.execute("INSERT INTO users(id, username, language) VALUES(?,?,?)", (uid, uname, lang))
            conn.commit()
        finally:
            conn.close()
    ...
    def create_room(room):
        ...
        try:
            conn.execute(
                "INSERT INTO rooms(code, creator_id, chat_id, max_players, password, current_turn, is_started, "
                "last_message_id, chance_deck, risk_deck, awaiting_buy, awaiting_buyout, language, player_ids, "
                "allow_buyout, turn_time, allow_partial_build) "
                "VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                (room.code, room.creator_id, room.chat_id, room.max_players, room.password,
                 ...
                 room.awaiting_buy, room.awaiting_buyout, room.language,
                 json.dumps(list(room.player_ids)), room.allow_buyout, room.turn_time,
                 room.allow_partial_build))
            conn.commit()
            return True
    ...
    def get_room(code):
        ...
        try:
            ...
            r = dict(zip(cn, row))
            room = Room(
                code=r['code'], creator_id=r['creator_id'], chat_id=r['chat_id'],
                max_players=r['max_players'], password=r['password'],
                current_turn=r['current_turn'], is_started=bool(r['is_started']),
                ...
                allow_partial_build=bool(r.get('allow_partial_build', 0)),
            ...
            for pr in c.fetchall():
                ...
                room.players[p['user_id']] = Player(
                    user_id=p['user_id'], name=p['name'], money=p['money'],
                    position=p['position'], color=p['color'], is_bot=bool(p['is_bot']),
                    in_jail=bool(p['in_jail']), jail_turns=p['jail_turns'],
    ...
    def update_room(room):
        ...
        try:
            conn.execute(
                "UPDATE rooms SET current_turn=?, is_started=?, last_message_id=?, chance_deck=?, risk_deck=?, "
                "awaiting_buy=?, awaiting_buyout=?, language=?, player_ids=?, allow_buyout=?, turn_time=?, "
                "allow_partial_build=? WHERE code=?",
                (room.current_turn, room.is_started, room.last_message_id,
                 json.dumps(room.chance_deck), json.dumps(room.risk_deck),
                 room.awaiting_buy, room.awaiting_buyout, room.language,
                 json.dumps(list(room.player_ids)), room.allow_buyout, room.turn_time,
                 room.allow_partial_build, room.code))
            conn.commit()
    ...
    def add_player(code, player):
        ...
        try:
            conn.execute(
                "INSERT INTO players(room_code, user_id, name, money, position, color, is_bot, in_jail, "
                "jail_turns, is_active, doubles_count) VALUES(?,?,?,?,?,?,?,?,?,?,?)",
                (code, player.user_id, player.name, player.money, player.position, player.color,
                 player.is_bot, player.in_jail, player.jail_turns, player.is_active, player.doubles_count))
            conn.commit()
            return True
        except sqlite3.IntegrityError:
            return False
    ...
    def update_player(code, player):
        ...
        try:
            conn.execute(
                "UPDATE players SET money=?, position=?, in_jail=?, jail_turns=?, is_active=?, "
                "doubles_count=? WHERE room_code=? AND user_id=?",
    ...
    def remove_ownership(code, idx):
        conn = sqlite3.connect(str(DB_PATH))
        try:
            conn.execute("DELETE FROM ownership WHERE room_code=? AND cell_idx=?", (code, idx))
            conn.commit()
        finally:
            conn.close()
    ...
    def set_user_room(uid, code):
        conn = sqlite3.connect(str(DB_PATH))
        try:
            conn.execute("INSERT OR REPLACE INTO user_room(user_id, room_code) VALUES(?,?)", (uid, code))
            conn.commit()
        finally:
            conn.close()
    ...
    def get_all_rooms():
        ...
        try:
            ...
            for row in c.fetchall():
                ...
                rooms.append({
                    'code': row[0], 'has_password': bool(row[1]),
                    'max_players': row[2], 'current_players': c.fetchone()[0]
                })
            return rooms
        finally:
            conn.close()
...
def calc_rent(cell, houses, cnt=1, dice=0, full=False):
    g = cell.get("group")
    if g == "station":
        return cell["rent"][min(cnt - 1, 3)]
    elif g == "utility":
        return (cell["rent"][0] if cnt == 1 else cell["rent"][1]) * max(dice, 7)
    else:
        r = cell["rent"][min(houses, 5)]
        return r * 2 if houses == 0 and full else r


def buyout_price(cell, h):
    return int(cell.get("price", 0) * 1.5 + h * cell.get("house", 50))


def sell_price(cell, h):
    return int(cell.get("price", 0) * 0.5 + h * cell.get("house", 50) * 0.5)


def get_props(room, pid):
    return [(i, BOARD[i], h) for i, (oid, h) in room.ownership.items()
            if oid == pid and BOARD[i]["type"] == "property"]


def count_stations(room, pid):
    return sum(1 for i, c in enumerate(BOARD)
               if c.get("group") == "station" and i in room.ownership and room.ownership[i][0] == pid)


def count_utils(room, pid):
    return sum(1 for i, c in enumerate(BOARD)
               if c.get("group") == "utility" and i in room.ownership and room.ownership[i][0] == pid)


def all_stations(room, pid):
    return count_stations(room, pid) == 4


def three_streets(room, pid):
    return sum(1 for g in ["brown", "lightblue", "pink", "orange", "red", "yellow", "green", "darkblue"]
...
def render_board(room):
    ...
    for idx in range(40):
        ...
        if tp == "property" and c.get("group") in GROUP_COLORS_HEX:
            ...
            if idx <= 10:
                draw.rectangle([x1 + 2, y2 - 12, x2 - 2, y2 - 2], fill=gc)
            elif idx <= 20:
                draw.rectangle([x2 - 12, y1 + 2, x2 - 2, y2 - 2], fill=gc)
            elif idx <= 30:
...
async def cancel_buy_timer(code):
    ...
    if st.get('buy_timer') and not st['buy_timer'].done():
        st['buy_timer'].cancel()
        st['buy_timer'] = None


async def start_buy_timer(room_code):
    st = get_room_state(room_code)
    if st.get('buy_timer') and not st['buy_timer'].done():
        st['buy_timer'].cancel()
    st['buy_timer'] = asyncio.create_task(_buy_timer_task(room_code))


async def _buy_timer_task(room_code):
    try:
...
async def do_delay(code, secs, key):
    """Dynamic countdown — updates board every 2 seconds but counts every second."""
    room = db.get_room(code)
    if not room:
        return
    st = get_room_state(code)
    st['in_cooldown'] = True
    if key == 'moving_countdown':
        st['is_moving'] = True

    last_update = 0
    for r in range(secs, 0, -1):
        now = time.time()
        # Update board every 2 seconds, or on first and last second
        if now - last_update >= 2.0 or r == secs or r == 1:
            last_update = now
            room = db.get_room(code)
            if not room:
                break
...
async def send_board(room, force=False, timer_text=None):
    ...
    for uid in room.player_ids:
        ...
        if now - last < MIN_EDIT_INTERVAL and not force:
            continue
        ...
        if (cur and room.is_started and uid == cur.user_id
            ...
            if room.can_roll and room.awaiting_buy is None:
                ...
                # Build button
                idx = cur.position
                cb_ok, cost = can_build(room, cur.user_id, idx)
                if cb_ok:
                    cell = BOARD[idx]
                    _, h = room.ownership[idx]
                    if h < 4:
                    ...
                    kb_buttons.append([InlineKeyboardButton(
                        text=lb, callback_data=f"build_{room.code}_{idx}")])
                # Trade button
                if not cur.is_bot:
                    kb_buttons.append([InlineKeyboardButton(
                        text=t('trade', room.language),
                        callback_data=f"trade_{room.code}")])
            ...
            if room.awaiting_buy is not None:
                ...
                if room.awaiting_buyout:
                    ...
                    kb_buttons.append([InlineKeyboardButton(
                        text=t('buyout_property', room.language, cell['name'], buyout_price(cell, h)),
            ...
            if cur.money < 0 and room.awaiting_buy is None:
                for pi, pc, ph in get_props(room, cur.user_id):
                    sp = sell_price(pc, ph)
                    kb_buttons.append([InlineKeyboardButton(
                        text=t('sell_property', room.language, pc['name'], sp),
                        callback_data=f"sell_{room.code}_{pi}")])
        ...
        if uid in trades:
            kb_buttons.append([
                InlineKeyboardButton(
                    text=t('trade_confirm', room.language),
                    callback_data=f"tradeaccept_{room.code}_{uid}"),
                InlineKeyboardButton(
                    text=t('trade_reject', room.language),
                    callback_data=f"tradereject_{room.code}_{uid}")
            ])
        ...
        try:
            if uid in room.player_message_ids:
                try:
                    await bot.edit_message_media(
                        chat_id=uid,
                        message_id=room.player_message_ids[uid],
                    ...
                    if "not modified" in es:
                        ...
                        try:
                            msg = await bot.send_photo(
                                chat_id=uid,
                                photo=BufferedInputFile(img, filename="b.png"),
            ...
            logging.error(f"send_board to {uid}: {e}")
...
async def cb_browse(cb: CallbackQuery):
    ...
    if not rooms:
        await cb.message.edit_text(t('no_rooms', lang), reply_markup=InlineKeyboardMarkup(
            inline_keyboard=[
                [InlineKeyboardButton(text=t('create_room', lang), callback_data="create_room")],
    ...
    for r in rooms:
        ...
        if not r['has_password']:
            kbb.append([InlineKeyboardButton(
                text=t('join', lang, r['code']),
                callback_data=f"quickjoin_{r['code']}")])
    ...
    await cb.message.edit_text(text, reply_markup=InlineKeyboardMarkup(inline_keyboard=kbb),
                               parse_mode="Markdown")
...
async def cb_qjoin(cb: CallbackQuery):
    ...
    room = db.get_room(code)
    if not room:
        await cb.answer(t('room_not_found', lang), show_alert=True)
        return
    if room.password:
        await cb.answer(t('room_has_password', lang), show_alert=True)
        return
    if len(room.players) >= room.max_players:
        await cb.answer(t('room_full', lang), show_alert=True)
        return
    if cb.from_user.id in room.players:
        await cb.answer(t('already_in_room', lang), show_alert=True)
        return
    p = Player(user_id=cb.from_user.id, name=cb.from_user.full_name,
               color=get_available_color(room))
    if not db.add_player(room.code, p):
        await cb.answer(t('room_full', lang), show_alert=True)
        return
    room.players[p.user_id] = p
    room.player_ids.add(p.user_id)
...
async def cb_create(cb: CallbackQuery, state: FSMContext):
    lang = db.get_user_language(cb.from_user.id)
    await cb.message.edit_text(t('choose_max_players', lang),
                               reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                                   [InlineKeyboardButton(text="2", callback_data="max_2"),
                                    InlineKeyboardButton(text="3", callback_data="max_3")],
                                   [InlineKeyboardButton(text="4", callback_data="max_4"),
                                    InlineKeyboardButton(text="6", callback_data="max_6")],
                                   [InlineKeyboardButton(text="8", callback_data="max_8")]]))
...
async def cb_max(cb: CallbackQuery, state: FSMContext):
    lang = db.get_user_language(cb.from_user.id)
    mp = int(cb.data.split("_")[1])
    await state.update_data(max_players=mp)
    await cb.message.edit_text(t('password_question', lang, mp),
                               reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                                   [InlineKeyboardButton(text=t('with_password', lang),
                                                         callback_data="pass_yes")],
                                   [InlineKeyboardButton(text=t('no_password', lang),
                                                         callback_data="pass_no")]]))
...
async def cb_nopass(cb: CallbackQuery, state: FSMContext):
    ...
    await cb.message.edit_text(t('allow_buyout_question', lang),
                               reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                                   [InlineKeyboardButton(text=t('allow_buyout', lang),
                                                         callback_data="buyout_yes")],
                                   [InlineKeyboardButton(text=t('no_buyout', lang),
                                                         callback_data="buyout_no")]]))
...
async def cb_askpass(cb: CallbackQuery, state: FSMContext):
    lang = db.get_user_language(cb.from_user.id)
    await cb.message.edit_text(t('enter_password', lang))
...
async def msg_pass(msg: Message, state: FSMContext):
    ...
    await msg.answer(t('allow_buyout_question', lang),
                     reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                         [InlineKeyboardButton(text=t('allow_buyout', lang),
                                               callback_data="buyout_yes")],
                         [InlineKeyboardButton(text=t('no_buyout', lang),
...
async def cb_buyout_ch(cb: CallbackQuery, state: FSMContext):
    lang = db.get_user_language(cb.from_user.id)
    await state.update_data(allow_buyout=(cb.data == "buyout_yes"))
    await cb.message.edit_text(t('allow_partial_build_question', lang),
                               reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                                   [InlineKeyboardButton(text=t('allow_partial_build', lang),
                                                         callback_data="partial_yes")],
                                   [InlineKeyboardButton(text=t('no_partial_build', lang),
                                                         callback_data="partial_no")]]))
    await state.set_state(CreateRoom.wait_partial_build)


@router.callback_query(F.data.startswith("partial_"), StateFilter(CreateRoom.wait_partial_build))
async def cb_partial_build(cb: CallbackQuery, state: FSMContext):
    lang = db.get_user_language(cb.from_user.id)
    await state.update_data(allow_partial_build=(cb.data == "partial_yes"))
    await cb.message.edit_text(t('choose_turn_time', lang),
                               reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                                   [InlineKeyboardButton(text=t('seconds_15', lang),
                                                         callback_data="time_15")],
                                   [InlineKeyboardButton(text=t('seconds_30', lang),
                                                         callback_data="time_30")],
                                   [InlineKeyboardButton(text=t('seconds_60', lang),
...
async def cb_time(cb: CallbackQuery, state: FSMContext):
    tt = int(cb.data.split("_")[1])
    data = await state.get_data()
    lang = db.get_user_language(cb.from_user.id)
    code = generate_code()
    room = Room(
        code=code, creator_id=cb.from_user.id, chat_id=cb.from_user.id,
        max_players=data['max_players'], password=data.get('password'),
        language=lang, allow_buyout=data['allow_buyout'],
        allow_partial_build=data.get('allow_partial_build', False),
        turn_time=tt)
    p = Player(user_id=cb.from_user.id, name=cb.from_user.full_name,
               color=get_available_color(room))
    room.players[p.user_id] = p
    ...
    if not db.create_room(room):
        await cb.answer("Error creating room", show_alert=True)
        return
...
async def show_lobby(m, room):
    ...
    pb = t('enabled', room.language) if room.allow_partial_build else t('disabled', room.language)
    text = t('room_info', room.language, room.code,
             room.password or t('none', room.language),
             len(room.players), room.max_players, bs, pb, room.turn_time, pt)
    kb = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=t('add_bot', room.language),
                              callback_data=f"addbot_{room.code}")],
        [InlineKeyboardButton(text=t('start_game', room.language),
                              callback_data=f"start_{room.code}")],
        [InlineKeyboardButton(text=t('refresh', room.language),
                              callback_data=f"lobby_{room.code}")]])
    if isinstance(m, CallbackQuery):
        try:
            await m.message.edit_text(text, reply_markup=kb, parse_mode="Markdown")
        except:
            await m.answer()
    else:
...
async def cb_start(cb: CallbackQuery):
    ...
    if not room:
        await cb.answer("Room not found!", show_alert=True)
        return
    if cb.from_user.id != room.creator_id:
        await cb.answer(t('only_creator_start', lang), show_alert=True)
        return
    if len(room.players) < 2:
        await cb.answer(t('need_min_players', lang), show_alert=True)
        return
...
async def cb_join_menu(cb: CallbackQuery, state: FSMContext):
    lang = db.get_user_language(cb.from_user.id)
    await cb.message.edit_text(t('enter_room_code', lang))
...
async def msg_jcode(msg: Message, state: FSMContext):
    ...
    room = db.get_room(code)
    if not room:
        await msg.answer(t('room_not_found', lang))
        await state.clear()
        return
    if room.password:
        await state.update_data(join_code=code)
        await msg.answer(t('room_has_password', lang))
...
async def msg_jpass(msg: Message, state: FSMContext):
    ...
    if not room:
        ...
        await state.clear()
        return
    if msg.text.strip() != room.password:
        await msg.answer(t('wrong_password', lang))
        return
    await do_join(msg, room, state)
...
async def do_join(msg, room, state):
    lang = db.get_user_language(msg.from_user.id)
    if msg.from_user.id in room.players:
        await msg.answer(t('already_in_room', lang))
        await state.clear()
        return
    if len(room.players) >= room.max_players:
        await msg.answer(t('room_full', lang))
        await state.clear()
        return
    p = Player(user_id=msg.from_user.id, name=msg.from_user.full_name,
               color=get_available_color(room))
    if not db.add_player(room.code, p):
        await msg.answer("Room is full!")
        await state.clear()
        return
    room.players[p.user_id] = p
    room.player_ids.add(p.user_id)
    db.set_user_room(msg.from_user.id, room.code)
    db.update_room(room)
    await state.clear()
...
# ─── TRADE MONEY INPUT (state handler) ───
@router.message(StateFilter(TradeMoneyInput.waiting))
async def handle_trade_money_input(message: Message, state: FSMContext):
    data = await state.get_data()
    code = data.get('trade_code')
    phase = data.get('trade_phase')
    if not code:
        await state.clear()
        return
    await state.clear()
    ...
    if phase == 'want':
        ...
        if target and amount > target.money:
            amount = target.money
        if amount <= 0:
            return
        ...
        if cur:
            for pi, pc, ph in get_props(room, cur.user_id):
                btns.append([InlineKeyboardButton(
                    text=f"🏠 {pc['name']} ({ph}🏠)",
                    callback_data=f"tgive_{code}_prop_{pi}")])
        btns.append([InlineKeyboardButton(
            text=t('trade_money', room.language),
            callback_data=f"tgive_{code}_money")])
        btns.append([InlineKeyboardButton(
            text=t('trade_cancel', room.language),
            callback_data=f"tcancel_{code}")])
        await message.answer(t('trade_select_give', room.language),
                             reply_markup=InlineKeyboardMarkup(inline_keyboard=btns))
    elif phase == 'give':
        cur = room.current_player()
        if cur and amount > cur.money:
            amount = cur.money
        if amount <= 0:
            return
...
# ─── EMOJI HANDLER — catches only emojis, excludes all states ───
@router.message(~StateFilter(
    CreateRoom.wait_password, CreateRoom.wait_max, CreateRoom.wait_buyout,
    CreateRoom.wait_partial_build, CreateRoom.wait_turn_time,
    JoinRoom.wait_code, JoinRoom.wait_password,
    TradeMoneyInput.waiting))
async def handle_emoji(message: Message):
    text = message.text.strip() if message.text else ""
    uid = message.from_user.id
    if not text or not EMOJI_RE.fullmatch(text):
        return
    try:
        await message.delete()
    except:
    ...
    if not room or not room.is_started or uid not in room.players:
        return
    st = get_room_state(room.code)
    st['emojis'][uid] = (time.time(), text)
    await send_board(room, force=True)
...
async def cb_roll(cb: CallbackQuery):
    ...
    room = db.get_room(code)
    if not room or not room.is_started:
        await cb.answer("Game not active!", show_alert=True)
        return
    cur = room.current_player()
    if not cur or cur.user_id != cb.from_user.id:
...
async def process(room, player, dice, dbl=False):
    ...
    if ct == "go":
        ...
        await handle_prop(room, player, cell, dice, dbl)
    elif ct == "chance":
        card = random.choice(room.chance_deck)
        await apply_card(room, player, card, "🎲", dbl)
    elif ct == "chest":
        amt = random.choice([50, 100, 150, 200])
        player.receive(amt)
        db.update_player(room.code, player)
        room.add_event(t('chest_reward', room.language, player.name, amt))
        await send_board(room)
        await finish()
    elif ct == "risk":
        card = random.choice(room.risk_deck)
        await apply_card(room, player, card, "⚠️", dbl)
    elif ct == "tax":
    ...
    if idx in room.ownership:
        ...
        if oid == player.user_id:
            ...
            if dbl:
                    ...
                    if cb2:
                        ...
                        if room:
                            ...
                            if p:
                                ...
                                if c2:
                                    p.pay(co2)
                                    _, hh = room.ownership[idx]
                                    room.ownership[idx] = (p.user_id, hh + 1)
                                    db.set_ownership(room.code, idx, p.user_id, hh + 1)
                                    db.update_player(room.code, p)
                                    if hh + 1 >= 5:
                                        room.add_event(t('hotel_built', room.language,
                                                         p.name, cell['name']))
                                    else:
                ...
                # Not doubles — check if can build, give time
            ...
            g = cell.get("group")
            if g == "station":
                rent = calc_rent(cell, h, count_stations(room, oid), dice)
            elif g == "utility":
                rent = calc_rent(cell, h, count_utils(room, oid), dice)
            else:
                rent = calc_rent(cell, h, 1, dice, owns_full_group(room, oid, g))
            player.pay(rent)
            owner.receive(rent)
            db.update_player(room.code, player)
        ...
        if player.money >= cell["price"]:
            ...
            if not player.is_bot:
                ...
                if room and room.awaiting_buy == idx:
                    ...
                    if p:
                        p.pay(cell["price"])
                        room.ownership[idx] = (p.user_id, 0)
                        db.set_ownership(room.code, idx, p.user_id, 0)
                        room.awaiting_buy = None
                        room.awaiting_buyout = False
                        db.update_room(room)
                        db.update_player(room.code, p)
                        room.add_event(t('property_bought', room.language,
                                         p.name, cell['name'], cell['price']))
                        if all_stations(room, p.user_id):
                            await end_game(room, p, 'stations')
                            return
                        if three_streets(room, p.user_id):
                            await end_game(room, p, 'streets')
                            return
                await finish()
        else:
...
async def check_debt(room, player):
    if player.money < 0:
        ...
        if total + player.money < 0:
            ...
            for pi, _, _ in props:
                if pi in room.ownership:
                    del room.ownership[pi]
                db.remove_ownership(room.code, pi)
            a = room.active_players()
            if len(a) <= 1 and a:
                await end_game(room, a[0], 'last_standing')
        else:
...
async def end_turn(room):
    ...
    if cur:
        room.add_event(t('player_turn', room.language, cur.name))
    logging.info(f"[{code}] end_turn: next player={cur.name if cur else 'None'}, can_roll={room.can_roll}")
    await send_board(room, force=True)
    await start_turn_timer(room.code)
...
async def cb_build(cb: CallbackQuery):
    ...
    if not ok:
        await cb.answer(t('max_houses', room.language), show_alert=True)
        return
    cell = BOARD[idx]
    _, h = room.ownership[idx]
    cur.pay(cost)
    room.ownership[idx] = (cur.user_id, h + 1)
    db.set_ownership(room.code, idx, cur.user_id, h + 1)
    db.update_player(room.code, cur)
    db.update_room(room)
    await cb.answer()
    if h + 1 >= 5:
        room.add_event(t('hotel_built', room.language, cur.name, cell['name']))
    else:
        room.add_event(t('house_built', room.language, cur.name, cell['name'], h, h + 1))
...
async def cb_buy(cb: CallbackQuery):
    ...
    if room.awaiting_buy is None or room.awaiting_buyout:
        await cb.answer("Nothing to buy!", show_alert=True)
        return
    idx = room.awaiting_buy
    cell = BOARD[idx]
    if cur.money < cell["price"]:
        await cb.answer(t('not_enough_ruzcoin', room.language), show_alert=True)
        return
    cur.pay(cell["price"])
...
async def cb_buyout(cb: CallbackQuery):
    ...
    if room.awaiting_buy is None or not room.awaiting_buyout:
        await cb.answer("Nothing to buyout!", show_alert=True)
        return
    idx = room.awaiting_buy
    if idx not in room.ownership:
        await cb.answer("Property not owned!", show_alert=True)
        return
    cell = BOARD[idx]
    oid, h = room.ownership[idx]
    bp = buyout_price(cell, h)
    ...
    owner = room.players.get(oid)
    if not owner:
        await cb.answer("Owner not found!", show_alert=True)
        return
    cur.pay(bp)
    owner.receive(bp)
    room.ownership[idx] = (cur.user_id, h)
    db.set_ownership(room.code, idx, cur.user_id, h)
    room.awaiting_buy = None
    room.awaiting_buyout = False
    await cancel_buy_timer(room.code)
    db.update_room(room)
...
async def cb_sell(cb: CallbackQuery):
    ...
    if not cur or cur.user_id != cb.from_user.id:
        await cb.answer(t('not_your_turn', room.language), show_alert=True)
        return
    if pi not in room.ownership:
        await cb.answer("Property not found!", show_alert=True)
        return
    oid, h = room.ownership[pi]
    if oid != cur.user_id:
        await cb.answer("Not your property!", show_alert=True)
        return
    cell = BOARD[pi]
    sp = sell_price(cell, h)
    cur.receive(sp)
    del room.ownership[pi]
    db.remove_ownership(room.code, pi)
    db.update_player(room.code, cur)
...
# ─── TRADE SYSTEM ───
@router.callback_query(F.data.regexp(r"^trade_[A-Z0-9]{6}$"))
async def cb_trade_start(cb: CallbackQuery):
    ...
    await cb.answer()
    try:
        await cb.message.answer(t('trade_select_player', room.language),
                                reply_markup=InlineKeyboardMarkup(inline_keyboard=btns))
    except:
        pass
...
async def cb_trade_player(cb: CallbackQuery):
    ...
    if not target:
        await cb.answer("Player not found!", show_alert=True)
        return
    st = get_room_state(code)
    st['trade_building'][cb.from_user.id] = {
        'target': target_id, 'want': None, 'give': None, 'step': 'want'}
    btns = []
    for pi, pc, ph in get_props(room, target_id):
        btns.append([InlineKeyboardButton(
            text=f"🏠 {pc['name']} ({ph}🏠)",
            callback_data=f"twant_{code}_prop_{pi}")])
    btns.append([InlineKeyboardButton(
        text=t('trade_money', room.language),
        callback_data=f"twant_{code}_money")])
    btns.append([InlineKeyboardButton(
        text=t('trade_cancel', room.language),
        callback_data=f"tcancel_{code}")])
    try:
        await cb.message.edit_text(t('trade_select_want', room.language),
                                   reply_markup=InlineKeyboardMarkup(inline_keyboard=btns))
    except:
        pass
...
async def cb_trade_want(cb: CallbackQuery, state: FSMContext):
    ...
    if not tb:
        await cb.answer("No active trade!", show_alert=True)
        return
    ...
    if wtype == "money":
        ...
        await cb.message.edit_text(
            f"{t('trade_enter_money', room.language)}\n(max: ${max_money})")
    ...
    btns.append([InlineKeyboardButton(
        ...
        callback_data=f"tcancel_{code}")])
    try:
        await cb.message.edit_text(t('trade_select_give', room.language),
                                   reply_markup=InlineKeyboardMarkup(inline_keyboard=btns))
    except:
        pass
...
async def cb_trade_cancel(cb: CallbackQuery, state: FSMContext):
    code = cb.data.split("_")[1]
    st = get_room_state(code)
    if cb.from_user.id in st.get('trade_building', {}):
        del st['trade_building'][cb.from_user.id]
    await state.clear()
    try:
...
async def cb_trade_accept(cb: CallbackQuery):
    ...
    if not trade:
        await cb.answer("No pending trade!", show_alert=True)
        return
    ...
    to_p = room.players.get(target_uid)
    if not from_p or not to_p:
        await cb.answer("Error!")
        if target_uid in st['trades']:
    ...
    if give[0] == 'money':
        ...
        if idx in room.ownership and room.ownership[idx][0] == from_uid:
            _, h = room.ownership[idx]
            room.ownership[idx] = (target_uid, h)
    ...
    if three_streets(room, from_uid):
        ...
        return
    if three_streets(room, target_uid):
